---
title: sublime,vim 配置
date: 2016-04-30 15:31:00
categories: 技术
tags: [工具]
description: sublime,vim 配置
---
...
ref: https://segmentfault.com/a/1190000002596724
...
if performance_mode
    set laststatus=2
    "	set statusline=[%n]\ %m%f%r%h\ \|\ \ pwd:\ %{CurDir()}\ \ \|%=\|\ %l,%c\ %L\ %p%%\ \|\ ascii=%b,hex=%b%{((&fenc==\"\")?\"\":\"\ \|\ \".&fenc)}\ \|\ %Y\@\ %{&ff}\
    set statusline=[%n]\ %m%f%r%h\ \|\ \ pwd:\ %{CurDir()}\ \ \|%=\|\ %l,%c\ %L\%{((&fenc==\"\")?\"\":\"\ \|\ \".&fenc)}\ \|\ %Y\@\ %{&ff}\
else
    set laststatus=2
    set statusline=
...
let Tlist_max_Tag_length = 16
"authorinfo
"http://www.vim.org/scripts/script.php?script_id=2902
"need nerdcommenter
"http://www.vim.org/scripts/script.php?script_id=1218
let g:vimrc_author='wangfengfeng'
let g:vimrc_homepage=''
let g:vimrc_email ='wangfengfeng@baidu.com'
nmap <leader>auth :AuthorInfoDetect<cr>
...
"for php develop, add by wonly
au FileType php setlocal dict+=~/.vim/plugin/php_funclist.txt
...
"hotkey list,start & end tag is '='
"<leader> is char ','
"=,ff= format js indent, relay on vimdir/plugin/jsbeautify.vim
